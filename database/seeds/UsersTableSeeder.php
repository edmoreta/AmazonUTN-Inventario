...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('inv_usuarios')->insert([
            ...
            'usu_direccion' => 'Quito',
            'usu_telefono' => '062345678',
            'usu_celular' => '+593934543234',
            'usu_email' => 'perez@utn.edu.ec',
            'usu_password' => bcrypt('12345678'),
            'usu_created_at' => Carbon::now(),
            'usu_updated_at' => Carbon::now()
        ]);
        DB::table('inv_usuarios')->insert([
            ...
            'usu_apellido' => 'Lima',
            'usu_fechaN' => '1992/1/3',
            'usu_direccion' => 'Av. 13 de octubre -Atuntaqui',
            'usu_telefono' => '+59362345678',
            'usu_celular' => '0934543234',
            'usu_email' => 'lima@hotmail.com',
            'usu_password' => bcrypt('12345678'),
            'usu_created_at' => Carbon::now(),
            'usu_updated_at' => Carbon::now()
        ]);
        DB::table('inv_usuarios')->insert([
            ...
            'usu_nombre' => 'Francis',
            'usu_apellido' => 'Gutierrez',
            'usu_fechaN' => '1992/1/3',
            'usu_direccion' => 'calle Bolívar -Atuntaqui',
            'usu_telefono' => '062345678',
            'usu_celular' => '+593934543234',
            'usu_email' => 'gutirrez3@gmail.com',
            'usu_password' => bcrypt('12345678'),
            'usu_created_at' => Carbon::now(),
            'usu_updated_at' => Carbon::now()
        ]);
