	...
	{{Form::token()}}
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<label for="prv_nombre">Nombre</label> <label for="prv_nombre" style="color:red">*</label>
						<input type="text" name="prv_nombre" maxlength="100" pattern="([a-zA-Z]| |ñ|Ñ|á|Á|é|É|í|Í|ó|Ó|ú|Ú)+" minlength="3" value="{{ $proveedor->prv_nombre }}" required class="form-control">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
