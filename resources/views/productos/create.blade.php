...
@section('contenido')
    ...
    {!! Form::open(['url' => 'productos','files'=>'true']) !!}
        ...
        <input type="hidden" name="codigo" value="{{ 'PRO-'.$cod }}" disabled class="form-control">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="pro_costo" value="{{old('pro_costo')}}" step="0.01" min="0.01" required class="form-control" placeholder="Costo...">
                </div>
            </div>
        {{-- </div> --}}
        {{-- <div class="row"> --}}
        ...
        {{-- <div class="row"> --}}
            <div class="col col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="pro_precio" value="{{old('pro_precio')}}" step="0.01" min="0.01" required class="form-control" placeholder="Precio...">
                </div>                
                ...
                <div class="row"> 
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="pro_stock" value="{{old('pro_stock')}}" step="1" min="" required class="form-control" placeholder="Stock...">
                        </div>
                    </div>
                </div>
